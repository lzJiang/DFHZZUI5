  ...
  METHOD set.
    ...
    CASE ls_input-zlllx.
      WHEN '01'.
        ...
        SORT lt_collect BY zj storagelocation.
        DELETE ADJACENT DUPLICATES FROM lt_collect COMPARING zj storagelocation.
        LOOP AT lt_collect INTO DATA(ls_collect).
          ...
          CLEAR:<fs_item>-requestedqty,<fs_item>-manufacturingorder,<fs_item>-yy1_mfgbatch_ord.
    ...
    LOOP AT lt_item ASSIGNING FIELD-SYMBOL(<fs_item>).
      ...
      SELECT SINGLE a~material,
       ...
       WHERE a~material = @<fs_item>-a-zj
         ...
         AND c~plant = @ls_head-a-productionplant
        INTO @DATA(ls_batch_valuetp).
      IF sy-subrc = 0.
        <fs_detail>-materialmfgdate = |{ ls_batch_valuetp-materialmfgdate+0(4) }-{ ls_batch_valuetp-materialmfgdate+4(2) }-{ ls_batch_valuetp-materialmfgdate+6(2) }|
    && |T00:00:00.000Z|.
