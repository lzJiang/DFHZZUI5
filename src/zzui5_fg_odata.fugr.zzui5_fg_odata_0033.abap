...
*"----------------------------------------------------------------------
  ...
  "1.检查
  zclui5_odata_util_0009=>check( CHANGING ls_input = ls_input ).
  IF ls_input-flag NE 'E'.
     zclui5_odata_util_0009=>post( CHANGING ls_input = ls_input ).
  ENDIF.
  return_code = 'S'.
